    ...
    <div style={{ minHeight: '100vh', display: 'flex', fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{
        ...
        <h1 style={{
          ...
          Manage your<br />
          <span style={{ color: '#93c5fd' }}>business smarter</span>
        </h1>
        <p style={{ color: '#94a3b8', fontSize: '16px', lineHeight: 1.6, maxWidth: '320px', marginBottom: '48px' }}>
          One platform to manage clients, leads, projects, and your entire team — all in one place.
        </p>

        {/* Feature bullets */}
        {[
          { icon: '✓', text: 'Client & Lead management' },
        ...
        <div style={{ width: '100%', maxWidth: '420px' }}>
          ...
          <div style={{ marginBottom: '36px' }}>
            ...
            <p style={{ color: '#64748b', fontSize: '15px' }}>
              Set up your organization and get started in minutes
            </p>
          </div>
